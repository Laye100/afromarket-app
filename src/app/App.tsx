    ...
    <SideMenuProvider>
      <>
        <div className="relative min-h-screen">
          ...
          {/* Side Menu Toggle */}
          <MenuButton variant="floating" className="fixed top-4 left-4 z-50" />
          ...
          <div className={`fixed top-4 right-4 bg-white rounded-lg shadow-lg p-4 space-y-2 z-50 max-w-xs lg:max-w-none transition-transform transform ${
            ...
            <button
              onClick={() => handleNavigate('productDetail')}
              className={`block w-full text-left px-3 py-2 rounded text-sm font-medium transition-colors ${
            ...
            >
              14. Annulation Commande
            </button>
            <button
              onClick={() => handleNavigate('order-cancellation-confirmation')}
              className={`block w-full text-left px-3 py-2 rounded text-sm font-medium transition-colors ${
                currentScreen === 'order-cancellation-confirmation'
                  ? 'bg-[#0F7B6C] text-white'
                  : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
              }`}
            >
              15. Confirmation Annulation
            </button>
            <button
            ...
            >
              19. Confirmation Demande Retour
            </button>
            <button
